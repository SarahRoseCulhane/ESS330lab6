...
map_aridity <- ggplot(data = camels, aes(x = gauge_lon, y = gauge_lat)) +
  ...
  labs(title = "Map of Sites by Aridity", x = "Longitude", y = "Latitude", color = "Aridity") +
  theme_minimal()

# Map colored by mean precipitation (p_mean)
map_p_mean <- ggplot(data = camels, aes(x = gauge_lon, y = gauge_lat)) +
  borders("state", colour = "gray50") +
  geom_point(aes(color = p_mean)) +
  scale_color_viridis_c(option = "plasma") + 
  labs(title = "Map of Sites by Mean Precipitation", x = "Longitude", y = "Latitude", color = "Mean Precip.") +
  theme_minimal()
...
Looking at the workflow rank result, it looks like the neutral rand_forest model outperformed the xgboost model and the neutral network model. It looks like both models outperformed the linear_reg model. Going forward, I would use the rand_forest model.
